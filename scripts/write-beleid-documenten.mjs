...
if (!fs.existsSync(SRC)) { console.error("FOUT: " + SRC + " niet gevonden. Draai eerst scripts/fetch-bs2-documents.mjs."); process.exit(1); }
...
console.log(`Geladen: ${E.length} BS2-beleid-documenten\n`);
...
console.log(`\n=== EINDREPORT ===`);
console.log(`Bron-docs: ${E.length} | geüpsert: ${up} | skip: ${sk} | errors: ${err}`);
