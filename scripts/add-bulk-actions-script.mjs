#!/usr/bin/env node
/**
 * v3 Fase E.10 — Wire bulk-actions.js in alle HTML pagina's met edit-flows
 * NA realtime-sync.js (de standaard load-sequence-anchor).
 *
...
const ANCHOR = '<script src="realtime-sync.js?v=rt1"';
const NEW_LINE = '  <script src="bulk-actions.js?v=ba1" defer></script>';
...
for (const file of htmlFiles) {
  ...
  if (src.includes("bulk-actions.js")) { skipped++; continue; }
