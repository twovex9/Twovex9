...
| 35 | Mijn-gegevens | `docs/bs2-scrape/35-mijn-gegevens/` | 🟡 **IN-PROGRESS** PR wacht op merge. LOCKDOWN 30/30 ✅ + Bug #69 (topbar "Mijn gegevens"-link wees naar instellingen.html ipv self-reference, fix naar mijn-gegevens.html) gefixt — wacht op 2 HARDCORE CLEAN RUNS post-merge. |
