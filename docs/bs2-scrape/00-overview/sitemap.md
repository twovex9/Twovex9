...
| 29 | Audit | `docs/bs2-scrape/29-audit/` | 🟡 **IN-PROGRESS** PR wacht op merge. LOCKDOWN 30/30 ✅ + Bug #64 (Kolommen-kiezer TD-hide werkte alleen op TH, niet op TD-cellen → data-col attr toegevoegd in renderRow) — wacht op 2 HARDCORE CLEAN RUNS post-merge. |
