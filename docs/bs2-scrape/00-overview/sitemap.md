...
| 10 | HR - Salarisadministratie | `docs/bs2-scrape/10-hr-salarisadmin/` | 🟡 **LOCKDOWN 30/30 + 2 CLEAN RUNS — wacht op override**. Geen bugs gevonden. Data-pariteit functioneel 100% (history-count NA per design). |
