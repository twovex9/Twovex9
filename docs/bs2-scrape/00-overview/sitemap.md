...
| 30 | Organisatie - Rollen | `docs/bs2-scrape/30-organisatie-rollen/` | 🟡 **IN-PROGRESS** PR wacht op merge. LOCKDOWN 30/30 ✅ — **GEEN BUGS** gevonden (BS1 reeds 100% functionele pariteit). 5 sections + 14 rollen 1:1 match met BS2. BS1 superset (descriptions/search/empty-state/totaal/cache/live-refresh). User-count gap (BS2 127 vs BS1 1) is v3 Fase G item. CRUD-editor is v3 Fase E. |
