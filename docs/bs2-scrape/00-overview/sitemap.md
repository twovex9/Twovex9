...
| 33 | Instellingen - Entiteiten | `docs/bs2-scrape/33-instellingen-entiteiten/` | ✅ **DONE** (user-override 2026-05-14 "100% zekerheid bevestigd na hardcore deep-test"). PR #130 merged. LOCKDOWN 30/30 + 2 HARDCORE CLEAN RUNS ZONDER fix tussendoor. Bug #67 (UX: missing empty-state placeholder bij 0 search-results → "Geen entiteiten gevonden." toegevoegd) gefixt + verified live. 7 entiteiten 1:1 BS2 match (client/employee/disposition/invoice/quotation/Disposition/Phase). BS1 superset met Beschrijving + Aantal records-kolommen + Search + Count + Empty-state. Async counts uit Supabase: client=160, employee=103, disposition=251, invoice=990. |
| 34 | Instellingen - Notificaties | `docs/bs2-scrape/34-instellingen-notificaties/` | ✅ **DONE** (user-override 2026-05-14 "100% zekerheid bevestigd na hardcore deep-test"). PR #132 merged. LOCKDOWN 30/30 + 2 HARDCORE CLEAN RUNS ZONDER fix tussendoor + 3/3 modal close-ways. Bug #68 (inst-nt-modal × 2 missing close-ways Escape+Overlay defensieve fallback) gefixt + verified live. 8 notification types in DB. BS1 superset met Mijn notificaties-tab (user-prefs) + Search + Gearchiveerd-toggle + Kanaal-keuze. v3 user-keuze 2026-05-13 bindend: GEEN e-mails ooit → BS2 e-mail-flow expliciet NIET overgenomen. |
| 35 | Mijn-gegevens | `docs/bs2-scrape/35-mijn-gegevens/` | ✅ **DONE** (user-override 2026-05-14 "100% zekerheid bevestigd na hardcore deep-test"). PR #134 merged. LOCKDOWN 30/30 + 2 HARDCORE CLEAN RUNS ZONDER fix tussendoor. Bug #69 (topbar "Mijn gegevens"-link wees naar instellingen.html ipv self-reference → fix naar mijn-gegevens.html) gefixt + verified live. BS1 is bewust GDPR-focus (Art. 15 inzage + JSON-download + 5 AVG-rechten + 5 retention-policies) ipv BS2 profile-edit (zit elders in BS1: Instellingen → Mijn profiel-tab). v3 Fase G deferred: active-sessions feature. |
| 36 | Manual (/manual) | `docs/bs2-scrape/36-manual/` | ✅ **DONE** (user-override 2026-05-14 "100% zekerheid bevestigd na hardcore deep-test"). LOCKDOWN 30/30 + 2 HARDCORE CLEAN RUNS ZONDER fix tussendoor. **GEEN BUGS** — module bewust niet aanwezig in BS1 per user-keuze #7 (Documentatie: "GEEN — baas wordt zelf eigenaar/admin"). BS2 heeft uitgebreide /manual met 10 secties + video-embeds. BS1 vertrouwt op hands-on training + v3 Fase G.8 helpdesk-link (toekomst). Help-button in topbar bestaat als placeholder, non-functional tot Fase G.8. |
