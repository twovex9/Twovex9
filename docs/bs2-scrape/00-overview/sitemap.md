...
| 02 | Planning | `docs/bs2-scrape/02-planning/` | ✅ **100% HARDCORE batch 5 audit** (PR #49+#51 merged, batch 5 audit pending PR) — alle gaps gesloten via ZZZ-CLAUDE-TEST-2026-05-13 test-dienst |
